...
> [!tip] 단일 책임 원칙 : SRP(Single Responsibility Principle)
...
> [!tip] 개방 폐쇄 원칙 : OCP(Open-Closed Principle)
...
> [!tip] 리스코프 치환 원칙 : LSP(Liskov Substitution Principle)
...
> [!tip] 인터페이스 분리 원칙 : ISP(Interface Segregation Principle)
...
> [!tip] 의존성 역전 원칙 : DIP(Dependency Inversion Principle)
